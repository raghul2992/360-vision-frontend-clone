      ...
      <div className={`max-h-screen ${bgcolors.dark} flex-1`}>
        <div className='flex justify-center items-center'>
          <div className='flex flex-col items-center justify-center text-center h-full lg:h-screen px-4 sm:px-6 lg:px-0'>
            <h1
              className={`${textSizes.title2} ${textcolors.white} mb-2 text-xl sm:text-2xl lg:text-3xl`}
            >
              {t('forgot_password.title')}
            </h1>

            <span
              className={`${textcolors.white} ${textSizes.extrasmall} mb-3 text-sm sm:text-base lg:text-lg`}
            >
            ...
            {!resetLinkSent ? (
              <div
                className={`${bgcolors.white} p-4 sm:p-8 flex flex-col w-full sm:min-w-[340px] lg:min-w-[440px] mb-2 rounded-[20px]`}
              >
