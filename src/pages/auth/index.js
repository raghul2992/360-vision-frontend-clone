    ...
    <div className='flex h-screen flex-col lg:flex-row relative'>
      ...
      >
        <div className='flex justify-center items-center '>
          ...
          >
            <h1
              className={`${textSizes.title2} text-black mb-2 text-xl sm:text-2xl lg:text-3xl 4k:text-5xl`}
            >
              {t('auth_page.welcome')}
            </h1>
            <span
              className={`text-black ${textSizes.extrasmall} mb-3 text-sm sm:text-base lg:text-lg 4k:text-2xl`}
            >
            ...
            <div
              className={`text-center min-w-[64px] text-black text-xs sm:text-sm lg:text-base 4k:text-xl`}
            >
